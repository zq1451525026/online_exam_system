            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content" style="text-align: center;float: left;width: 100%"  >
                        <form  method="post" id="simple_add" action="testquestion/selectTf">
                            <div align="center">
                                <font color="black"><strong>判断题题干：</strong></font>&nbsp;
                            ...
                            <div class="col-md-8 column" align="left" >
                                        ...
                                        <span id="topicmark">
                                            ...
                                            <tr >
                                                <div class="option" style="display: none">
                                                    <td id="option0"><font color="red">正确答案：${pager.correct}&nbsp;</font>
                                                        &nbsp;&nbsp;&nbsp;
                                ...
                                <div style="font-size: large;padding-left: 30px;">
                                    ...
                                    <div style="padding-left: 370px;">
                                        <button type="submit" class="btn btn-primary" style="width: 100px;" >加入判断题</button>
                                    </div>
                                </div>
                            </div>
                            <input type="hidden" name="question_type" value="3">
...
<script>
    ...
    function toUpdate(c) {
        ...
        $.get('testquestion/update1/' + questionID, function (html) {
            //console.dirxml(html)
