                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content" style="text-align: center;float: left;width: 100%"  >
                        <form  action="testquestion/searchFsp" method="post" id="pro_select">
                            <div align="center">
                                <font color="black"><strong>编程题题干：</strong></font>&nbsp;
                            ...
                            <div class="col-md-8 column" align="left" >
                                ...
                                <div style="font-size: large;padding-left: 30px;">
                                    ...
                                    <div style="padding-left: 370px;">
                                        <button type="submit" class="btn btn-primary" style="width: 100px;" >加入编程题</button>
                                    </div>
                                </div>
                            </div>
                            <input type="hidden" name="question_type" value="6">
...
<script>
    function  toDelete(c) {
        ...
        $.get('testquestion/select/' + questionID, function (html) {
            //console.dirxml(html)
