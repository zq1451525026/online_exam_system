            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content" style="text-align: center;float: left;width: 100%"  >
                        <form  action="testquestion/searchFSP" method="post" id="pro_select">
                            <div align="center">
                                <font color="black"><strong>简答题题干：</strong></font>&nbsp;
                        ...
                        <form method="post" action="testquestion/insert" style="padding-left: 170px;">
                            ...
                            <div class="col-md-8 column" align="left" >
                                <%--显示搜索内容--%>
                                <div style="font-size: large;text-align: left;padding-left: 60px;">
                                    <c:forEach var="pager" items="${page}">
                                        ...
                                        <span id="topicmark">
                                            ...
                                            <td id="topic">${pager.id}.&nbsp;${pager.question}</td>
                                            <br>
                                        </tr>

                                        <tr >
                                            <div class="option" style="display: none">
                                                <td id="option0"><font color="red">正确答案：${pager.std_answer}</font>
                                                    <br>
                                                    <div style="padding-left: 150px;">
                                                    <a id="toUpdateBtn" questionID="${pager.id}"  onclick="toUpdate(this)" href="#" class="btn btn-info btn-xs"
                                                       data-toggle="modal" data-target="#updateModal" data-backdrop="static">
                                                        <span class="glyphicon glyphicon-refresh"></span> 更新</a>

                                                    <a id="todeletebtn" questionID="${pager.id}" onclick="toDelete(this)"  href="#" class="btn btn-danger btn-xs"
                                ...
                                <div style="font-size: large;padding-left: 30px;">
                                    ...
                                    <div style="padding-left: 370px;">
                                        <button type="submit" class="btn btn-primary" style="width: 100px;" >加入简答题</button>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    function toUpdate(c) {
        ...
        $.get('testquestion/update2/' + questionID, function (html) {
            //console.dirxml(html)
